...
<br><br><br><br><br><br>
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form:form class="form-login" action="loginVerify" method="post" commandName="login">
		        <h2 class="form-login-heading">Admin Login</h2>
		           <center> <span>${message}</span></center>
		        <div class="login-wrap">
		            <input type="text" class="form-control-login" name="userName" placeholder="User ID" autofocus>
		            <br>
